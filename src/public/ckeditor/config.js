...
CKEDITOR.editorConfig = function( config ){
	...
	config.filebrowserImageBrowseUrl = '/_admin/kcfinder/browse.php?type=images';
	config.filebrowserFlashBrowseUrl = '/_admin/kcfinder/browse.php?type=flash';
	config.filebrowserUploadUrl = '/_admin/plugins/upload.php?type=files';
	config.filebrowserImageUploadUrl = '/_admin/plugins/upload.php?type=images';
	config.filebrowserFlashUploadUrl = '/_admin/plugins/upload.php?type=flash';
	config.language = 'ru';
